...
<table class="messenger-list-item" data-contact="{{ $user->id }}">
    <tr data-action="0">
        ...
        <td style="position: relative">
            ...
            <div class="avatar av-{{ $user->id }} app-scroll" 
                style="background-image: url('{{ $avatarUrl }}'); width: 40px; height: 40px; border-radius: 50%; background-size: cover; background-position: center;">
            </div>
        </td>
        {{-- center side --}}
        <td>
