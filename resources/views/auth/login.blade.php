<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="text-center">
            <hr style="display:inline-block;width:30%;"> OR
        ...
        <div class="mb-4">
            ...
            <x-text-input id="email" class="block w-full mt-1 rounded-full" type="email" name="email"
        ...
        <div class="mb-4">
            ...
            <x-text-input id="password" class="block w-full mt-1 rounded-full" type="password" name="password" required
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
                ...
                &nbsp;
                <a class="underline text-sm text-gray-750 dark:text-gray-750 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800"
                    href="{{ route('register') }}">
                    {{ __('Register') }}
                </a>
            </div>
