...
<style>
    ...
    .bg-complimentary-nav {
        background-color: #E4AD68;
    }
    /* Darker shade for the active link background */
    .bg-complimentary-nav-darker {
        background-color: #8c6a40; /* A darker shade of #E4AD68 */
    }
</style>
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-4 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <a href="{{ route('admin.users.index') }}" class="{{ request()->routeIs('admin.users.index*') || request()->routeIs('admin.users.show') ? $activeLinkClasses : $inactiveLinkClasses }}">
                        {{ __('Users') }}
                    </a>
                    ...
                    <a href="{{ route('rooms.index') }}" class="{{ request()->routeIs('rooms.index*') || request()->routeIs('admin.rooms.single') ? $activeLinkClasses : $inactiveLinkClasses }}">
                        {{ __('Rooms') }}
                    </a>
                    <a href="{{ route('providers.index') }}" class="{{ request()->routeIs('providers.index*') || request()->routeIs('providers.single') ? $activeLinkClasses : $inactiveLinkClasses }}">
                        {{ __('Providers') }}
                    </a>
...
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('room.booking.index')" :active="request()->routeIs('booking')">
                        {{ __('All Bookings') }}
                    </x-nav-link>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('room.booking.index')">
                    {{ __('All Bookings') }}
                </x-responsive-nav-link>
                ...
                <x-responsive-nav-link :href="route('providers.index')">
                    {{ __('Providers') }}
                </x-responsive-nav-link>
