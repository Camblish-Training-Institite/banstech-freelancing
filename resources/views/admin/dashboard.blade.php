...
@section('content')
    ...
    <main class="flex-grow container mx-auto px-4 py-8 h-full">
        <h1 class="text-4xl font-extrabold mb-8 text-center text-dark-bg">Welcome to the Banstech Admin Panel!</h1>
        ...
        <div class="max-w-6xl mx-auto bg-white p-8 rounded-xl shadow-lg">
            ...
            <h2 class="text-3xl font-bold mb-6 text-dark-bg">Hello, {{ Auth::guard('admin')->user()->name}}!</h2>
