...
<div class="container mx-auto px-4 md:px-12">
    <div class="bg-white rounded-lg shadow-md p-6">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Request a Milestone for "{{ $project->job->title }}"</h2>

        <!-- add actionURL -->
        {{-- {{ route('freelancer.projects.milestone.request', $project) }} --}}
        <form action="" method="POST">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('freelancer.projects.show', $project) }}" class="inline-block align-baseline font-bold text-sm text-indigo-600 hover:text-indigo-800">
                    Cancel
                </a>
            </div>
        </form>
