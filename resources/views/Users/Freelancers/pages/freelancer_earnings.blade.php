        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-800">R 12,300.00</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <table class="w-full text-sm text-left text-gray-500">
                        ...
                        <tbody>
                            <tr class="bg-white border-b hover:bg-gray-50">
                                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">E-commerce Platform</th>
                                <td class="px-6 py-4">Phase 2: Backend Dev</td>
                                <td class="px-6 py-4">Sep 15, 2025</td>
                                <td class="px-6 py-4 font-semibold">R 2,500.00</td>
                                <td class="px-6 py-4">
                                    <span class="bg-yellow-100 text-yellow-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-full">In Review</span>
                                </td>
                            </tr>
                            <tr class="bg-white border-b hover:bg-gray-50">
                                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">CRM System</th>
                                <td class="px-6 py-4">Final Milestone</td>
                                <td class="px-6 py-4">Sep 10, 2025</td>
                                <td class="px-6 py-4 font-semibold">R 2,000.00</td>
                                <td class="px-6 py-4">
                                    <span class="bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-full">Funded</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="mb-4">
                    <label for="amount" class="block mb-2 text-sm font-medium text-gray-900">Amount to withdraw</label>
                ...
                <div class="mb-4">
                    ...
                    <select id="method" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5">
