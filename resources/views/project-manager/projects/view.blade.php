...
<div class="container mx-auto px-4 md:px-12">
    <div class="flex w-full justify-start">
        <a href="{{ route('pm.dashboard') }}" class="back-link">← Back to Dasboard</a>
    </div>
            ...
            <div x-data="{ tab: 'details' }">
                ...
                <div class="py-6">
                    <div x-show="tab === 'details'">
                        @include('project-manager.projects.tabs.details')
                    </div>
                    <div x-show="tab === 'payments'">
                        @include('project-manager.projects.tabs.payments')
                    </div>
                    <div x-show="tab === 'files'">
                        @include('project-manager.projects.tabs.files')
                    </div>
                    <div x-show="tab === 'tasks'">
                        @include('project-manager.projects.tabs.tasks')
                    </div>
                </div>
            </div>
        </div>
